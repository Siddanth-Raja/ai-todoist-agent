...
> **Current state — September 14, 2026; external-Blinn-blocker exception approved. Git and the Obsidian export manifest determine publication state.**
>
...
> - **Approved direction:** [PCOS product architecture](PCOS-product-architecture.md) was published at the prior baseline above; section 73 records the approved external-pause exception to its roadmap sequence.
